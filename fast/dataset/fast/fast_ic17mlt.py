...
from fast.dataset.utils import get_ic17mlt_ann as get_ann
...
from fast.dataset.utils import scale_aligned_short, center_crop
...
class FAST_IC17MLT(data.Dataset):
    def __init__(self, split='train', is_transform=False, img_size=None, short_size=640,
                 pooling_size=9, with_rec=False, read_type='pil', repeat_times=1, use_val=False, report_speed=False):
        self.split = split
...
if __name__ == '__main__':
    ...
    dataloader = FAST_IC17MLT(split='train', is_transform=True, img_size=640,
                                     short_size=640, pooling_size=9, read_type='cv2')
